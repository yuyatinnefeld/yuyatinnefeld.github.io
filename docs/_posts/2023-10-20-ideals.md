...
<img src="/images/post-20231020/interface-segregation.png" alt="Software interface segregation" style="border: 1px solid  gray;">

The first option is the Backend for Frontends (BFF) pattern, which entails having a dedicated API gateway for each client type, often referred to as a distinct BFF for each client, as shown in the illustration. 
